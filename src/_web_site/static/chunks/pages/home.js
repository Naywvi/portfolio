                ...
                value: function () {
                  return b(
                    ...
                    b(
                      ...
                      b(
                        "div",
                        { className: "work-item-description ma_recherche" },
                        b(
                          "p",
                          null,
                          "Moi c'est Nagib, enchanté 😁 ravi de vous rencontrer ! J'ai 25 ans et je suis passionné par l'informatique. J'aime m'impliquer dans divers projets et je cherche constamment à les mener à bien de la meilleure manière possible."
                        ),
                        b(
                          "p",
                          null,
                          "J'ai consacré trois années à ma formation en tant que développeur FULL STACK. Je prépare actuellement mon BAC+3 SI à l'école ESGI de Paris."
                        ),
                        b(
                          "p",
                          null,
                          "Ayant de solides compétences en développement, je vous invite à explorer mon parcours à travers les projets que j'ai réalisés."
                        ),
                        b(
                          "p",
                          null,
                          "Ma passion pour l'inconnu me pousse à rechercher continuellement de nouvelles opportunités."
                        ),
                        b(
                          "p",
                          { className: "white" },
                          b(
                            "a",
                            { href: "/projets" },
                            "👉 Je vous invite à me cliquer dessus afin de découvrir mes projets. 👈"
                          )
                        )
                      )
                    ),
                    b(
                      ...
                      b(
                        "div",
                        { className: "work-item-title padding_recherche" },
                      ...
                      b(
                        ...
                        b(
                          "p",
                          null,
                          "Je souhaite trouver une entreprise qui serait disposée à m'accueillir en tant qu'apprenti développeur, pour participer à des projets ambitieux."
                        ),
                        b(
                          "p",
                          null,
                          "Mon engagement serait flexible, d'une durée variable allant de 1 à 3 ans, avec un rythme de trois semaines en entreprise suivi d'une semaine à l'école. Je suis disponible pour commencer dès que possible."
                        ),

                        b("br", null, null),
                        b(
                          "a",
                          { href: "/curriculum", className: "proj_link" },
                          "Je vous invite à visionner mon cv 📍"
                        )
                      )
                    )
                    // b(
                    ...
                    //     "Follow the instructions one at a time, if you have a problem contact support"
                    //   ),
                    //   b(
                    //     "div",
                    //     { className: "full" },
                    //     b("img", { src: "./img/Step.png" })
                    //   )
                    // )
                    //Card-----------------------
                    ...
                    //     "div",
                    //     { className: "work-item-description" },
                    //     "The cutest scary skeleton"
                    //   ),
                    //   b(
                    //     "div",
                    //     { className: "full" },
                    //     b("img", { src: "/img/Spooky-Basic-hero.png" })
                    //   ),
                    //   b(
                    //     "div",
                    //     { className: "grid" },
                    ...
                    //       "div",
                    //       { className: "card" },
                    //       b("img", { src: "/img/Spooky-Basic-commande01.png" })
                    //     ),
                    //     b(
                    //       "div",
                    //       { className: "card" },
                    //       b("img", { src: "/img/Spooky-Basic-commande01" })
                    //     )
                    //   )
                    // ),
                    // b(
                    ...
                    //     "div",
                    //     { className: "work-item-description" },
                    //     "Becomes fashionable and frighteningly powerful"
                    //   ),
                    //   b(
                    //     "div",
                    //     { className: "full" },
                    //     b("img", { src: "/img/Spooky-VIP-hero.png" })
                    //   ),
                    //   b(
                    //     "div",
                    //     { className: "grid" },
                    ...
                    //       "div",
                    //       { className: "card" },
                    //       b("img", { src: "/img/Spooky-VIP-commande01.png" })
                    //     ),
                    //     b(
                    //       "div",
                    //       { className: "card" },
                    //       b("img", { src: "/img/Spooky-VIP-commande02.png" })
                    //     )
                    //   )
                    // ),
                    ...
                    //     "div",
                    //     { className: "work-item-description" },
                    //     "Reach the top and have access to all the commands, become a king"
                    //   ),
                    //   b(
                    //     "div",
                    //     { className: "full" },
                    //     b("img", { src: "/img/Spooky-Premium-hero.png" })
                    //   ),
                    //   b(
                    //     "div",
                    //     { className: "grid" },
                    ...
                    //       { className: "card" },
                    //       b("img", {
                    //         src: "/img/Spooky-Premium-commande01.png",
                    //       })
                    //     ),
                    //     b(
                    //       "div",
                    //       { className: "card" },
                    //       b("img", {
                    //         src: "/img/Spooky-Premium-commande02.png",
                    //       })
                    //     )
                    //   )
                    // ),
