                  ...
                  return b(
                    ...
                    b(
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Les adresses IP cataloguées sont stockées de manière persistante par le programme. Vos données restent ainsi sauvegardées entre les exécutions du programme."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Filtrage par masque réseau"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Vous pouvez rechercher des adresses IP en fonction d'une adresse et d'un masque fournis par l'utilisateur. IP Grinde renverra les adresses stockées appartenant au même sous-réseau que celui fourni."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Les adresses IP peuvent être affichées sous différentes formes : binaire ou hexadécimale. Vous pouvez choisir la représentation qui vous convient le mieux."
                      ),
                      b("h3", { className: "desc_title" }, "Validation"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "IP Grinde effectue une validation stricte pour s'assurer que seules les adresses IP/masques valides sont acceptées. Cela vous empêche d'entrer autre chose que des adresses IP valides."
                      ),

                      b("h3", { className: "desc_title" }, "Boucle Principale"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Vous pourrez aussi sauvegarder vos données, puis ensuite les afficher de nouveau."
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "IP Grinde fonctionne comme un menu interactif avec l'utilisateur et ne se ferme que lorsque l'utilisateur le souhaite. Vous pouvez effectuer des actions telles que l'ajout d'une nouvelle adresse IP, la liste des adresses IP, la recherche par masque, la suppression d'une adresse IP ou la sortie du programme."
                      ),
                      b(
                        "p",
                        { className: "proj_cot" },
                        "IP Grinde est un outil pratique pour gérer des adresses IP, qu'il s'agisse de cataloguer, de filtrer ou de les afficher dans divers formats. Il garantit également que seules des adresses IP/masques valides sont acceptées, ce qui facilite la gestion de ces ressources importantes."
                      ),
                      b(
                        "a",
                        {
                          className: "proj_link",
                          href: "https://github.com/Naywvi/Ip_grinde",
                        },
                        "https://github.com/Naywvi/Ip_grinde"
                      )
                    )
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                  );
