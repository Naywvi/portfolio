                ...
                value: function () {
                  return b(
                    ...
                    b(
                      "div",
                      { className: "desc_proj" },
                      b("h3", { className: "desc_title" }, "Persistance"),

                      b(
                        "p",
                        { className: "info_proj" },
                        "La refonte de l'entreprise vise à offrir une gamme complète de services d'hébergement, en mettant l'accent sur l'intégration avec Discord pour cibler la communauté des joueurs et les utilisateurs de cette plateforme de communication."
                      ),
                      b(
                        "h3",
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "MongoDB est utilisé pour stocker de manière flexible les données liées aux utilisateurs, aux serveurs de jeu, aux configurations et à d'autres informations importantes pour l'entreprise."
                      ),
                      b("h3", { className: "desc_title" }, "Bot Discord"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Un bot Discord personnalisé a été développé pour permettre une intéraction fluide entre les utilisateurs et les services de l'entreprise. Il peut être utilisé pour automatiser des tâches, gérer les commandes des utilisateurs, envoyer des notifications, etc."
                      ),
                      b("h3", { className: "desc_title" }, "Plesk"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Plesk, une interface de gestion de serveurs web, est intégré pour simplifier la gestion de l'hébergement web. Il permet aux utilisateurs de gérer leurs sites, domaines, bases de données et autres ressources web de manière efficace."
                      ),
                      b("h3", { className: "desc_title" }, "API centrale"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Une API centrale est mise en place pour faciliter la communication entre les différents composants du projet. Cela permet une intégration étroite et l'interopérabilité de l'ensemble de l'infrastructure."
                      ),
                      b("h3", { className: "desc_title" }, "API Pterodactyl"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "L'API Pterodactyl est utilisée pour gérer les serveurs de jeu. Cette plateforme permet la création, la gestion et la surveillance automatisée des serveurs de jeu, ce qui est essentiel pour les joueurs."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Module boutique (Shop)"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Les utilisateurs ont la possibilité d'acheter des services et des produits via un module boutique. Ils peuvent choisir parmi une variété de forfaits, notamment l'hébergement web, les serveurs de jeu et les VPS."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Création d'un CMS (Content Management System)"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Un CMS personnalisé a été développé pour gérer le contenu du site web de l'entreprise, ce qui simplifie la mise à jour et la gestion des informations sur les produits, les actualités et d'autres contenus."
                      ),
                      b("h3", { className: "desc_title" }, "Espace Web"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Les utilisateurs peuvent bénéficier de l'hébergement de leurs propres sites web ou applications grâce à l'espace web fourni, ce qui étend les offres de l'entreprise au-delà de la seule location de serveurs."
                      ),

                      b(
                        "p",
                        { className: "proj_cot" },
                        "Ce projet combine efficacement des technologies et des services pour offrir une solution complète aux utilisateurs qui souhaitent créer, gérer et héberger leurs propres communautés de jeux en ligne et de sites web tout en intégrant Discord, une plateforme de communication très populaire."
                      ),
                      b(
                        "a",
                        {
                          className: "proj_link",
                          href: "https://letsplaygames.fr/lpgames/",
                        },
                        "Service de jeu"
                      ),
                      b(
                        ...
                        {
                          className: "proj_link",
                          href: "https://letsplaygames.fr/lpweb/",
                        },
                        "Service web"
                      ),
                      b(
                        ...
                        {
                          className: "proj_link",
                          href: "https://letsplaygames.fr/lpdashboard/",
                        },
                        "Dashboard"
                      ),
                      b(
                        ...
                        {
                          className: "proj_link",
                          href: "https://letsplaygames.fr/lplogin/",
                        },
                        "Espace de connexion"
                      )
                    )
