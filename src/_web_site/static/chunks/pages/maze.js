                  ...
                  return b(
                    ...
                    b(
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Il s'agit d'un jeu d'aventure à la troisième personne se déroulant dans un monde généré de manière procédurale, rempli de mystères et de défis. Les joueurs se lancent dans un voyage palpitant où la disposition du monde, les quêtes et les rencontres sont générées dynamiquement, assurant une expérience unique à chaque partie."
                      ),
                      b(
                        "h3",
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Le monde du jeu est généré de manière procédurale, offrant une aventure différente à chaque partie. Explorez des paysages variés, des forêts luxuriantes aux grottes périlleuses et aux ruines anciennes."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Participez à des quêtes et des défis qui s'adaptent à l'évolution du monde. Résolvez des énigmes, combattez des ennemis et découvrez les secrets du jeu."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Vivez le jeu depuis une perspective à la troisième personne, vous plongeant dans le voyage du personnage."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "🦸‍♂️ Progression du Personnage"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Personnalisez et faites évoluer votre personnage au fur et à mesure de votre progression dans le jeu. Débloquez de nouvelles compétences et de l'équipement pour affronter des défis plus difficiles."
                      ),
                      b(
                        "p",
                        { className: "proj_cot" },
                        "Maze offre une expérience de jeu variée et captivante grâce à sa génération procédurale, ses quêtes dynamiques et sa perspective à la troisième personne. Les joueurs auront l'opportunité de personnaliser leur personnage et de débloquer de nouvelles compétences tout en explorant un monde en constante évolution."
                      ),
                      b(
                        "a",
                        {
                          className: "proj_link",
                          href: "https://github.com/Naywvi/Procedural_maze_Unity",
                        },
                        "https://github.com/Naywvi/Procedural_maze_Unity"
                      )
                    )
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                  );
