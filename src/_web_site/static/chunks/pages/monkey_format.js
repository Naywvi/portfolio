                  ...
                  return b(
                    ...
                    b(
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Cette application est conçue pour être simple et accessible, permettant aux utilisateurs de formater n'importe quel fichier texte, que ce soit un fichier de code, un fichier Markdown, un fichier de configuration, un fichier journal, ou un fichier de script."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Formatage de tout fichier texte"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Monkey Format Files offre la possibilité de formater n'importe quel fichier texte, ce qui facilite la mise en forme des documents conformément à vos besoins peut importe sa taille."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Personnalisation des options de formatage"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Les utilisateurs peuvent personnaliser les options de formatage pour s'assurer que le fichier est présenté de la manière souhaitée."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Une fois le formatage terminé, l'application permet de sauvegarder le fichier formaté pour une utilisation ultérieure."
                      ),

                      b(
                        "p",
                        { className: "proj_cot" },
                        "L'objectif de Monkey Format Files est de simplifier le processus de formatage des fichiers texte, offrant aux utilisateurs une solution conviviale pour mettre en forme des documents de divers types. Cette application est particulièrement utile pour les développeurs, les rédacteurs techniques et tout utilisateur qui travaille avec des fichiers texte et souhaite les présenter de manière claire et cohérente."
                      ),
                      b(
                        "a",
                        {
                          className: "proj_link",
                          href: "https://github.com/Naywvi/Monkey_format_files_windows_app",
                        },
                        "https://github.com/Naywvi/Monkey_format_files_windows_app"
                      )
                    )
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                  );
