                  ...
                  return b(
                    ...
                    b(
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Monkey Scrap, une application pour le navigateur Firefox qui offre la possibilité de collecter des données à partir de n'importe quelle page web. Cette application est conçue pour simplifier le processus de collecte d'informations en permettant aux utilisateurs de scraper (extraire) des données de manière flexible."
                      ),
                      b(
                        "h3",
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Monkey Scrap permet de collecter des informations à partir de diverses sources sur une page web, qu'il s'agisse de textes, d'images, de liens, de tableaux, ou d'autres types de contenu."
                      ),
                      b("h3", { className: "desc_title" }, "Personnalisation"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Les utilisateurs peuvent configurer le scraper en fonction de leurs besoins, en précisant les données spécifiques à extraire."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "L'application offre une interface utilisateur conviviale pour simplifier le processus de scraping, même pour les utilisateurs novices."
                      ),
                      b("h3", { className: "desc_title" }, "Flexibilité"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Monkey Scrap peut être utilisé pour collecter des données sur une grande variété de sites web, ce qui en fait un outil polyvalent."
                      ),
                      b(
                        "p",
                        { className: "proj_cot" },
                        "L'objectif de Monkey Scrap est de rendre la collecte de données sur le web plus accessible et plus efficace, en permettant aux utilisateurs de scraper des informations pertinentes de manière ciblée. Que ce soit pour la recherche, l'analyse de marché, ou d'autres besoins, Monkey Scrap offre une solution pratique pour extraire des données à partir de pages web."
                      ),
                      b(
                        "a",
                        {
                          className: "proj_link",
                          href: "https://github.com/Naywvi/Monkey_scrap_firefox",
                        },
                        "https://github.com/Naywvi/Monkey_scrap_firefox"
                      )
                    )
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                  );
