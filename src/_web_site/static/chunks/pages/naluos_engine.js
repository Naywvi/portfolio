                  ...
                  return b(
                    ...
                    b(
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Naluos Engine est un puissant moteur de jeu JavaScript conçu par Naywvi, un développeur passionné. L'objectif du moteur est de fournir un outil facile à utiliser et à apprendre, tout en offrant une grande flexibilité."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Créez des jeux en 2D"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Naluos Engine permet aux développeurs de créer des jeux en deux dimensions, ouvrant ainsi un large éventail de possibilités créatives."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Prise en charge de WebGL et Canvas"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Le moteur est compatible avec les technologies WebGL et Canvas, garantissant une expérience de jeu fluide et polyvalente."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Bibliothèque complète d'outils et d'API"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Les développeurs bénéficient d'un ensemble complet d'outils et d'interfaces de programmation d'application (API) pour créer des jeux personnalisés."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                        "Documentation détaillée et tutoriels"
                      ),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Naluos Engine offre une documentation exhaustive et des tutoriels pour aider les développeurs à exploiter pleinement le potentiel du moteur (disponible sur github)."
                      ),
                      b(
                        "h3",
                        { className: "desc_title" },
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        "Un jeu de démonstration est disponible sur le github. Il s'agit d'un simple jeu de plateforme en 2D qui met en avant les fonctionnalités de Naluos Engine en reprenant le célèbre jeu, MARIO."
                      ),
                      b("h3", { className: "desc_title" }, "Site web"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Le site web du projet présente Naluos Engine et fournit des informations sur le téléchargement, l'installation et l'utilisation du moteur. Les développeurs trouveront des ressources utiles pour commencer à créer des jeux avec Naluos Engine."
                      ),
                      b("h3", { className: "desc_title" }, "Téléchargement"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "La version 1.0 de Naluos Engine est disponible en téléchargement sur github, offrant aux développeurs la possibilité de commencer à créer des jeux en utilisant ce moteur performant et flexible."
                      ),
                      b(
                        "a",
                        {
                          className: "proj_link",
                          href: "https://github.com/Naywvi/Naluos_Engine_js",
                        },
                        "https://github.com/Naywvi/Naluos_Engine_js"
                      )
                    )
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                  );
