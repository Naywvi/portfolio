                  ...
                  return b(
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/revochat/revochat_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Revochat est une plateforme en web3 basée sur la blockchain. Elle permet aux utilisateurs d'être propriétaires de leurs données. Similaire à Discord, mais avec un accent sur la sécurité et la confidentialité. Toutes les données sont encryptées. Disponible en tant qu'application web et mobile."
                        ),
                        b(
                          "p",
                          { className: "skills" },
                          "Langages  : NodeJs, Typescript, Solidity, HTML, CSS"
                        ),
                        b(
                          "p",
                          { className: "skills" },
                          "Technologie web : Tailwind"
                        ),
                        b(
                          "p",
                          { className: "skills" },
                          "Technologie : Sockets, Smart contracts, WebRTC"
                        ),
                        b("p", { className: "skills" }, "Database  : MongoDB"),
                        b(
                          "p",
                          { className: "skills" },
                          "Organisation : Trello, Figma, Github, Github project"
                        ),
                        b(
                          "a",
                          {
                            href: "/projets?projet=revochat",
                    ...
                    b(
                      ...
                      b(
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "L'entreprise a été restructurée pour proposer des services d'hébergement de serveurs de jeu, d'hébergement web, et de VPS liés à Discord. Les éléments clés de la refonte incluent une base de données MongoDB, un bot Discord pour l'intégration, l'utilisation de Plesk pour l'hébergement web, une API centrale pour la communication, l'API Pterodactyl pour la gestion des jeux, un module boutique, un CMS personnalisé, et la fourniture d'un espace web."
                        ),
                        b(
                          "p",
                          { className: "skills" },
                          "Langages  : NodeJs, typescript, HTML, CSS"
                        ),
                        b(
                          "p",
                          { className: "skills" },
                          "Technologie : Boostrap, Pleask, Pterodactyl, CMS"
                        ),
                        b("p", { className: "skills" }, "Database  : MongoDB"),
                        b(
                          "p",
                    ...
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    b("h1", { className: "title titlep" }, "Spooky projet"),
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/spooky_project/spooky_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Spooky Projet est un projet qui permet d'exécuter des commandes sur votre propre compte Discord (selfbot). Il comprend un site web, un bot Discord et un bot serveur. Le site web permet la gestion du compte et l'achat des rangs VIP ou Premium."
                        ),
                        b("p", { className: "skills" }, "Langages  : Nodejs"),
                        b(
                          "p",
                          { className: "skills" },
                        ...
                        b(
                          "a",
                          {
                            href: "/projets?projet=spooky_project",
                            className: "contact-cta proj_button",
                          },
                          "en savoir plus"
                        )
                    ...
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    b("h1", { className: "title titlep" }, "Scrip't IO"),
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/scriptio/scriptio_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Script'IO est une plateforme de commerce électronique spécialisée dans la vente de scripts légaux. La plateforme offre des fonctionnalités telles qu'un panneau d'administration pour gérer les demandes d'audit, une section utilisateur pour répertorier ou acheter des produits, et la possibilité de gérer et de modifier ses propres annonces. Chaque utilisateur dispose d'un profil personnel avec une note de confiance globale et un historique de ventes."
                        ),
                        b(
                          "p",
                          { className: "skills" },
                        ...
                        b(
                          "p",
                          { className: "skills" },
                          "Organisation : Github, Draw.io"
                        ),
                        b(
                          "a",
                          {
                            href: "/projets?projet=scriptio",
                            className: "contact-cta proj_button",
                          },
                          "en savoir plus"
                        )
                    ...
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    b("h1", { className: "title titlep" }, "Naluos RPG"),
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/naluos_rpg/naluos_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Naluos RPG est un jeu de rôle, il propose une expérience simple et accessible, où les joueurs peuvent explorer la ville de Nalua et découvrir son histoire. Le jeu permet d'explorer la ville, d'interagir avec les personnages et de découvrir l'histoire de la cité."
                        ),
                        b("p", { className: "skills" }, "Langages  : Python"),
                        b("p", { className: "skills" }, "Librairies  : Pygame"),
                        b(
                          "p",
                          { className: "skills" },
                          "Mapping  : Tiles-pygame"
                        ),
                        b(
                          "p",
                          { className: "skills" },
                        ...
                        b(
                          "a",
                          {
                            href: "/projets?projet=naluos_rpg",
                            className: "contact-cta proj_button",
                          },
                          "en savoir plus"
                        )
                    ...
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    b("h1", { className: "title titlep" }, "Naluos Engine"),
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/naluos_engine/naluos_engine_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Naluos Engine est un moteur de jeu JavaScript. Il se veut facile à utiliser et à apprendre, tout en offrant une grande flexibilité. Il permet de créer des jeux en 2D, prend en charge WebGL et Canvas, propose une bibliothèque complète d'outils et d'API, et offre une documentation détaillée ainsi que de des tutoriels."
                        ),
                        b(
                          "p",
                          { className: "skills" },
                        ...
                        b(
                          "a",
                          {
                            href: "/projets?projet=naluos_engine",
                            className: "contact-cta proj_button",
                          },
                          "en savoir plus"
                        )
                    ...
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    b("h1", { className: "title titlep" }, "Maze procedural"),
                    ...
                    b(
                      ...
                      b(
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Projet de jeu d'aventure à la troisième personne procédural. Créé avec Unity, offrant une expérience d'aventure dynamique et immersive. Jeu se déroulant dans un monde généré de manière procédurale, rempli de mystères et de défis."
                        ),
                        b("p", { className: "skills" }, "Logiciel  : Unity"),
                        b("p", { className: "skills" }, "Langages  : C#, C++"),
                        b(
                          "p",
                          { className: "skills" },
                          "Concept  : Map procédural"
                        ),
                        b(
                          "p",
                          { className: "skills" },
                    ...
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    b("h1", { className: "title titlep" }, "Nlook'up"),
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/nlook_up/nlook_up_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Nlookup est une application C# permettant de récupérer des informations à partir de l'API de la NASA et d'effectuer des recherches. Il offre un accès à une multitude de données passionnantes issues de la vaste collection de la NASA. Vous aurez notamment la possibilité de rechercher par date les astéroides recensé par la nasa, ou bien de visualiser la \"Photo du Jour\"."
                        ),
                        b("p", { className: "skills" }, "Langages  : C#"),
                        b("p", { className: "skills" }, "API  : Nasa"),
                        b(
                          "p",
                          { className: "skills" },
                    ...
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    b("h1", { className: "title titlep" }, "NNVM"),
                    ...
                    b(
                      ...
                      b(
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "NNVM est un outil en ligne de commande permettant de configurer de nouvelles machines virtuelles (VM) de manière automatique. Il simplifie le processus de configuration des VM avec une seule commande."
                        ),
                        b("p", { className: "skills" }, "Langages  : Shell"),
                        b(
                          "a",
                          {
                            href: "/projets?projet=nnvm",
                            className: "contact-cta proj_button",
                          },
                          "en savoir plus"
                        )
                    ...
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                    b("h1", { className: "title titlep" }, "Ip grinde"),
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/ip_grinde/ip_grinde_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "IP Grinde est un utilitaire polyvalent pour cataloguer et gérer des adresses IP (IPv4). Il permet de stocker, filtrer, afficher et valider les adresses IP de manière efficace."
                        ),
                        b("p", { className: "skills" }, "Langages  : C#"),
                        b("p", { className: "skills" }, "Librairies  : Gtk+3"),
                        b(
                          "p",
                          { className: "skills" },
                          "Organisation : Github"
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/monkey_scrap/monkey_scrap_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Monkey Scrap est une application Firefox qui permet de collecter des données à partir de n'importe quelle page web."
                        ),
                        b(
                          "p",
                          { className: "skills" },
                        ...
                        b(
                          "a",
                          {
                            href: "/projets?projet=monkey_scrap",
                            className: "contact-cta proj_button",
                          },
                          "en savoir plus"
                        )
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("img", {
                          className: "proj",
                          src: "/proj/monkey_format/monkey_format_logo.png",
                        })
                      ),
                      b(
                        "div",
                        ...
                        b(
                          "p",
                          { className: "info_proj" },
                          "Monkey Format Files est une application Windows qui permet de formater n'importe quel fichier texte. Il offre des options de personnalisation pour le formatage et la possibilité de sauvegarder le fichier formaté. En ayant un affichage en direct, ainsi que des logs."
                        ),
                        b(
                          "p",
                          { className: "skills" },
                          "Langages  : Nodejs, HTML, CSS"
                        ),
                        b(
                          "p",
                          { className: "skills" },
                          "Librairie  : Electron-app"
                        ),
                        b(
                          "p",
                          { className: "skills" },
                        ...
                        b(
                          "a",
                          {
                            href: "/projets?projet=monkey_format",
                            className: "contact-cta proj_button",
                          },
                          "en savoir plus"
                        )
