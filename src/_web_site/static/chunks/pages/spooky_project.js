                  ...
                  return b(
                    ...
                    b(
                      ...
                      b(
                        ...
                        b("p", { className: "skills" }, "Organisation : Github")
                        // b(
                        //   "a",
                        //   {
                        //     href: "/#projet&id=aa",
                    ...
                    b(
                      ...
                      b(
                        "p",
                        { className: "info_proj" },
                        'Spooky Project est un projet qui offre la possibilité d\'exécuter des commandes sur votre propre compte Discord, ce qui est communément appelé un "selfbot". Le projet se compose de plusieurs éléments, dont un site web, un bot Discord et un bot serveur. Voici un aperçu plus détaillé. '
                      ),
                      b("h3", { className: "desc_title" }, "Site Web"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Le site web est la plateforme centrale pour gérer votre compte Discord. Vous pouvez y effectuer des actions telles que la gestion de votre profil, la modification des paramètres, l'achat de rangs spéciaux, tels que le rang VIP ou le rang Premium, qui peuvent offrir des fonctionnalités supplémentaires ou des avantages."
                      ),
                      b("h3", { className: "desc_title" }, "SelfBot Discord"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Le bot Discord est un composant du projet qui interagit avec Discord. Il est capable d'exécuter des commandes automatisées sur votre compte Discord, ce qui peut être utile pour automatiser certaines tâches ou effectuer des actions spécifiques sur le serveur Discord auquel vous êtes connecté. Il est important de noter que l'utilisation de selfbots peut être contraire aux conditions d'utilisation de Discord, il est donc essentiel de s'assurer que l'utilisation du bot est conforme aux politiques de Discord."
                      ),
                      b("h3", { className: "desc_title" }, "Bot Serveur"),
                      b(
                        "p",
                        { className: "info_proj" },
                        "Le bot serveur est un autre composant du projet qui interagit avec un serveur spécifique. Il peut être utilisé pour exécuter des commandes sur un serveur Discord particulier, fournir des fonctionnalités ou des automatisations spécifiques au serveur."
                      ),
                      b(
                        "p",
                        { className: "proj_cot" },
                        "Spooky Project offre donc une solution complète pour gérer votre compte Discord, exécuter des commandes automatisées et accéder à des fonctionnalités spéciales via le site web. Il est important de noter que l'utilisation de selfbots doit être effectuée conformément aux politiques de Discord pour éviter toute violation des conditions d'utilisation du service."
                      ),
                      ...
                      b(
                        ...
                        {
                          className: "proj_link",
                          href: "https://github.com/Naywvi/Spooky_project",
                        },
                        "https://github.com/Naywvi/Spooky_project"
                      )
                    )
                    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                  );
